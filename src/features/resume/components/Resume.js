...
import profilePhoto from '../content/images/me-photo.jpg'
import fifaApp from '../content/video/fifa.webm'
...
import { resumeItems, technicalSkills } from '../content/resume-content.js'
...
class Resume extends Component {
  ...
  handleScroll(e) {
    e.preventDefault()
    if (this.splash && this.about && this.resume && this.projects) {
        ...
        const { isSmoothScrolling, scrollDirection } = this.state
        const { currentSection, changeSection } = this.props
        const sections = [
        ...
        const nextSection = sections[currentSection + 1] && sections[currentSection + 1]
        const prevSection = sections[currentSection - 1] && sections[currentSection - 1]
